...
class ArduinoUploadDialog(wx.Dialog):
    ...
    def __init__(self, parent, st_code):
        ...
        self.check_ads = wx.CheckBox( self, wx.ID_ANY, u"ADS1115", wx.DefaultPosition, wx.Size( 65,-1 ), 0 )
        fgSizer1.Add( self.check_ads, 0, wx.ALL, 5 )
        self.check_ads.Bind(wx.EVT_CHECKBOX, self.onUIChange)
    ...
    def generateDefinitionsFile(self):
        ...
        if (self.check_ads.GetValue() == True):
             define_file += '#define ADS1115\n'
